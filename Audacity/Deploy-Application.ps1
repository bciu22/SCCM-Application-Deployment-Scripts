...
Try {
	...
	[string]$appScriptDate = '20151130'
	[string]$appScriptAuthor = 'Dan Lezoche, Charles Crossan'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Write-Log -Message "Installing Audacity"
		Execute-Process -Path 'audacity-win-2.1.0.exe' -Parameters '/verysilent'
        Write-Log -Message "Installing LAME"
        Execute-Process -Path 'Lame_v3.99.3_for_Windows.exe' -Parameters '/verysilent'
        Write-Log -Message "Installing FFMPEG"
        Execute-Process -Path 'ffmpeg-win-2.2.2.exe' -Parameters '/verysilent'
        ...
        If (Test-Path -Path "C:\Users\Public\Desktop\Audacity.lnk") { Remove-File -Path "C:\Users\Public\Desktop\Audacity.lnk" }
