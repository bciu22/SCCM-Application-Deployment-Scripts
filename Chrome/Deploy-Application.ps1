...
Try {
	...
	[string]$appVersion = 'x86/x64'
	[string]$appArch = '47.0.2526.106'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '20151221'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		#Execute-Process -Path 'vlc-2.2.1-win32.exe' -Parameters '/S'
        Execute-MSI -Action 'Install' -Path 'GoogleChromeStandaloneEnterprise.msi' -PassThru		
        ...
        {
		    Copy-File -Path "$dirFiles\master_preferences" -Destination "C:\Program Files (x86)\Google\Chrome\Application\master_preferences"
		}
        Else
        {
            Copy-File -Path "$dirFiles\master_preferences" -Destination "C:\Program Files\Google\Chrome\Application\master_preferences"
        }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        Execute-MSI -Action 'Uninstall' -Path 'GoogleChromeStandaloneEnterprise.msi' -PassThru
