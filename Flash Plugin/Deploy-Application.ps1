...
Try {
	...
	[string]$appVersion = '27.0.0.183'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '02'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '20171101'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-MSI -Action 'Install' -Path 'install_flash_player_27_plugin.msi' -PassThru		
        ...
        Else
        {
            Copy-File -Path "$dirSupportFiles\mms.cfg" -Destination "c:\windows\system32\macromed\flash"
        }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        Execute-MSI -Action 'Uninstall' -Path 'install_flash_player_27_plugin.msi' -PassThru
