...
Try {
	...
	[string]$appScriptDate = '20171102'
	[string]$appScriptAuthor = 'Mike Briganti'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        If ($is64Bit)
        {
            Execute-Process -Path 'Silverlight_x64.exe' -Parameters '/q'
        }
        Else
        {
            Execute-Process -Path 'Silverlight.exe' -Parameters '/q'
        }
