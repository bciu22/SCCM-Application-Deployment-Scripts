...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "VSCodeSetup-Stable.exe" -Parameters "/VERYSILENT"
		...
		Get-ChildItem "C:\Users" | Foreach-Object {
			Copy-Item -Recurse -Path "$dirSupportFiles\extensions" -Destination "$($_.FullName)\.vscode\extensions"
		}
