...
Try {
	...
	[string]$appVendor = 'PuTTY'
	[string]$appName = 'PuTTY'
	[string]$appVersion = '0.66'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '20151109'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps "putty,puttygen" -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path 'putty-0.66-installer.exe' -Parameters '/verysilent'
